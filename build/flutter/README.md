...
* `tetris_flet` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `Tetris Flet` - executable or bundle name on disk.
* `Tetris Flet` - display name shown in window titles and about app dialogs.
